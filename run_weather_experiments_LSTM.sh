    ...
    do
      ...
      do
        ...
        do
          ...
          python real_data.py --method WFA --LSTM_epochs 500 --hmm_rank $rank --hankel_epochs 300 --fine_tune_epochs 300 --N $n --new_test_data --noise 0. --no_nn_transition --seed $seed --regression_epochs 100 --L $l --LSTM_lr 0.1 --fine_tune_lr 0.1 --hankel_lr 0.1 --regression_lr 0.1 --no_batch_norm
      done
    done
  done
done